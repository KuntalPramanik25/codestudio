      ...
      <motion.button
        ...
        <div className="size-6 rounded-md bg-gray-800/50 p-0.5 group-hover:scale-110 transition-transform">
          <Image
            ...
            alt="Alternate logo for a Programming Language"
            width={24}
            height={24}
                  ...
                  <motion.div
                    ...
                    <button
                      ...
                      <div
                        ...
                        <div
                          className="absolute inset-0 bg-gradient-to-br from-blue-500/10 to-purple-500/10 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity"
                        />
                        <Image
                          width={24}
                          height={24}
