        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-24">
            <div className="relative inline-block">
              ...
              <h1
                className="relative text-5xl md:text-6xl lg:text-7xl font-extrabold bg-gradient-to-r
              ...
              <div className="relative p-8 md:p-12">
                ...
                <div className="text-center mb-12">
                  ...
                  <div className="flex items-baseline justify-center gap-2 mb-4">
                    ...
                    <span className="text-6xl font-bold bg-gradient-to-r from-gray-100 to-gray-300 text-transparent bg-clip-text">
                      1999
                    </span>
                    <span className="text-xl text-gray-400"> one-time</span>
                  </div>
                  <p className="text-gray-400 text-lg">Unlock the full potential of <span className="font-bold text-gray-200">CodeStudio</span></p>
                </div>
